...
export function NmAiStatementCard() {
  return (
    <Card as="section">
      ...
      <div className="flex flex-col justify-between px-6 pb-12 pt-4 text-slate-600">
        ...
        <p className="text-center font-semibold italic text-slate-500 mb-2">
