...
const MARKET_NEWS_CATEGORIES: CategoryDef[] = [
    // Commodities
    { id: 1, name: "Gold", slug: "gold", icon: "fa-solid fa-coins", gradient: "from-yellow-400 to-amber-500", badge: "COMMODITY" },
    { id: 6, name: "Oil", slug: "oil", icon: "fa-solid fa-droplet", gradient: "from-slate-700 to-slate-900", badge: "COMMODITY" },
    // Indices
    { id: 2, name: "Nikkei", slug: "nikkei", icon: "fa-solid fa-chart-bar", gradient: "from-red-500 to-rose-700", badge: "INDEX" },
    { id: 10, name: "Hang Seng", slug: "hang-seng", icon: "fa-solid fa-chart-bar", gradient: "from-red-700 to-red-900", badge: "INDEX" },
    // Crypto
    { id: 0, name: "Crypto", slug: "crypto", icon: "fa-brands fa-bitcoin", gradient: "from-orange-400 to-orange-600", badge: "CRYPTO" },
    // Currencies
    { id: 9, name: "AUD/USD", slug: "audusd", icon: "fa-solid fa-dollar-sign", gradient: "from-green-500 to-emerald-700", badge: "CURRENCIES" },
    { id: 10, name: "EUR/USD", slug: "eurusd", icon: "fa-solid fa-euro-sign", gradient: "from-blue-500 to-blue-700", badge: "CURRENCIES" },
    { id: 11, name: "GBP/USD", slug: "gbpusd", icon: "fa-solid fa-sterling-sign", "gradient": "from-violet-500 to-purple-700", badge: "CURRENCIES" },
    { id: 12, name: "USD/JPY", slug: "usdjpy", icon: "fa-solid fa-yen-sign", gradient: "from-blue-600 to-indigo-700", badge: "CURRENCIES" },
    { id: 13, name: "USD/CHF", slug: "usdchf", icon: "fa-solid fa-franc-sign", gradient: "from-red-500 to-red-700", badge: "CURRENCIES" },
    { id: 14, name: "US Dollar", slug: "us-dollar", icon: "fa-solid fa-dollar-sign", gradient: "from-green-600 to-green-800", badge: "CURRENCIES" },
];

const ECONOMIC_NEWS_CATEGORIES: CategoryDef[] = [
    { id: 0, name: "Global & Economy", slug: "economy", href: "economic-news/economy", icon: "fa-solid fa-globe", gradient: "from-teal-500 to-cyan-700", badge: "ECONOMIC" },
    { id: 0, name: "Fiscal & Monetary", slug: "fiscal-moneter", href: "economic-news/fiscal-moneter", icon: "fa-solid fa-landmark", gradient: "from-indigo-500 to-indigo-700", badge: "ECONOMIC" },
...
function CategoryCard({
    ...
    return (
        ...
        >
            ...
            {/* Gradient overlay */}
            <div className={`absolute inset-0 bg-gradient-to-br ${cat.gradient} ${thumbUrl ? "opacity-65 group-hover:opacity-75" : "opacity-100"} transition-opacity duration-300`} />
        ...
        <section className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-slate-100 space-y-10">
            ...
            <div>
                <div className="flex items-center justify-between mb-5">
                    ...
                    <Link href={`/${locale}/news`} className="text-xs font-semibold text-blue-600 hover:text-blue-800 transition">
                        View All &rsaquo;
                    </Link>
                </div>
